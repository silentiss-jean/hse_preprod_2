...
import { loadAllSummaryData } from "./summary.api.js";
import {
  extractSelectedIds,
...
export async function loadSummary() {
  ...
  try {
    ...
    try {
      ...
      const homeContainer = document.getElementById("summaryCard"); // le gros bloc Résumé général
    ...
    console.log("[summary] DEBUG options=", data.options);
    console.log("[summary] DEBUG pricingConfig=", pricingConfig);
